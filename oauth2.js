 ...
 * 403: error condition (details written to error log at error level)
 * 
...
function introspectAccessToken(r) {
    ...
    r.subrequest("/_oauth2_send_introspection_request", "token=" + r.variables.access_token + "&authorization=" + authHeader,
        function(reply) {
            ...
            try {
                r.log("OAuth token introspection response: " + reply.body)
                var response = JSON.parse(reply.body);
